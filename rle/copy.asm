...
.len	equ	3		; Count of words
	...
	mov [bp + 1], x2	; Save 'x2' to be restored later
	mov x2,    P3_RW	; Save a word & 1 cycle for each copy
	mov [bp + 2], xm	; Save 'xm' to be restored later
...
us_copy_lp:
	...
	mov [bp + 0], a		; Save 'a' to be restored later
...
.len	equ	2		; Count of words
	...
	mov x3,    [bp + .src]
	mov [bp + 1], x2	; Save 'x2' to be restored later (.src)
	mov x2,    [bp + .trg]
	mov c,     [bp + .len]
	mov [bp + 2], xm	; Save 'xm' to be restored later
